...
using KurumsalMimari.Core.CrossCuttingConcerns.Caching;
using PostSharp.Aspects;

namespace KurumsalMimari.Core.Aspects.Postsharp.CacheAspect
{
    [Serializable]
    public class CacheAspect:MethodInterceptionAspect
    {
        ...
        {
            //gönderilen cachetype bir cache manager türünde değilse
